...
public class FlyBehaviour : GenericBehaviour
{
    ...
    bool flybut = false;
    void flybutdown(object a,EventArgs aa) { flybut = true; }
    //void flybutup() { flybut = false; }
	// Start is always called after any Awake functions.
	void Start()
	{
        PlayerInputManager.getins().Joy0Left += flybutdown;
	...
	void Update()
	{
		...
		if (Input.GetButtonDown(flyButton)||flybut && !behaviourManager.IsOverriding() 
