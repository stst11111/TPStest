...
public class MoveBehaviour : GenericBehaviour
{
    ...
    void JumpButtonDown(object a,EventArgs i) { jumpbutton = true; }
    private UDPCNS _udpcns;
	...
	{
		// Get jump input.
		if (!jump && (jumpbutton|| Input.GetButtonDown(jumpButton)) && behaviourManager.IsCurrentBehaviour(this.behaviourCode) && !behaviourManager.IsOverriding())
		{
            jumpbutton = false;
			jump = true;
		}
